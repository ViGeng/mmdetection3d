...
Usage:
    python detect_and_visualize.py <path_to_pcd_file>
...
def create_visualization(pcd_path, pred_file, output_html):
    ...
    # Load point cloud
    points, intensity = load_kitti_bin(pcd_path)
...
Examples:
  python detect_and_visualize.py demo/data/kitti/000008.bin
  python detect_and_visualize.py demo/data/kitti/000008.bin --score-thr 0.5
  python detect_and_visualize.py demo/data/kitti/000003.bin
        """
    )
    ...
    parser.add_argument(
        'pcd_file',
        type=str,
        help='Path to point cloud file (.bin format)'
    )
    ...
    # Run detection
    pred_file = run_detection(args.pcd_file, args.output_dir, args.score_thr)
    
    # Create visualization
    create_visualization(args.pcd_file, pred_file, output_html)
